...
public class ServletUtils {
	...
	public static StockManager getStockManager(ServletContext servletContext) {
		synchronized (stockManagerLock) {
			if (servletContext.getAttribute(STOCK_MANAGER_ATTRIBUTE_NAME) == null) {
				servletContext.setAttribute(STOCK_MANAGER_ATTRIBUTE_NAME, StockManager.getInstance());
			}
		}
		return (StockManager) servletContext.getAttribute(STOCK_MANAGER_ATTRIBUTE_NAME);
	}
