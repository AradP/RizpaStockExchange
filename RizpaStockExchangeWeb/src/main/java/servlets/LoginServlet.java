    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameFromSession == null) {
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                 ...
                 */
                synchronized (this) {
                    if (userManager.isLoggedIn(usernameFromParameter)) {
                        ...
                        Role roleFromSession = Role.valueOf(request.getParameter(ROLE));
                        User user = new User(usernameFromParameter, roleFromSession);
